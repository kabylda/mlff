...
def get_resource_as_file(path):
  ...
  # Get the directory where this file (distribution.py) is located
  current_dir = Path(__file__).parent
  # Construct path to the data file
  data_path = current_dir / 'data' / 'partition_spline.npz'
...
class Distribution(object):
  ...
  def __init__(self):
    ...
    """
    spline_file = get_resource_as_file('partition_spline.npz')
