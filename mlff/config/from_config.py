...
def make_so3krates_sparse_from_config(
    ...
    return nn.SO3kratesSparse(
        ...
        electrostatic_energy_kspace_do_ewald_bool = getattr(model_config, 'electrostatic_energy_kspace_do_ewald_bool', None),
        electrostatic_energy_kspace_interp_nodes = getattr(model_config, 'electrostatic_energy_kspace_interp_nodes', None),
